    ...
    def __init__(self, bird_group, size, window_size):
        ...
        if self.side == "right":
            self.image_list = [pygame.transform.scale(pygame.image.load(
                "Assets/bird_frames/frame-1.png"), size),
                               ...
                               pygame.transform.scale(pygame.image.load(
                                   "Assets/bird_frames/Frame-3.png"), size),
                               pygame.transform.scale(pygame.image.load(
                                   "Assets/bird_frames/Frame-4.png"), size)
                               ]
        ...
        if self.side == "left":
            self.image_list = [pygame.transform.scale(
                               ...
                               pygame.transform.scale(
                               pygame.transform.flip(pygame.image.load(
                                   "Assets/bird_frames/Frame-3.png"), True, False), size),
                               pygame.transform.scale(
                               pygame.transform.flip(pygame.image.load(
                                   "Assets/bird_frames/Frame-4.png"), True, False), size),
                               ]
